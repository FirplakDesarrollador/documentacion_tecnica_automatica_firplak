...
test('actualiza sólo mezcla PINP, gelcoat PGEL y el peróxido bajo el gelcoat', () => {
  const result = applySyntheticMarbleBomQuantities([
    line('mix', 'PINP01-0006-000-0000'),
    line('gel', 'PGEL01-0003-000-0100'),
    line('peroxide-grams', 'CMPD01-0048-000-0000', 'GR', 'gel'),
    line('peroxide-kilos', 'CMPD01-0016-000-0000', 'KG', 'gel'),
    line('other', 'CMPD01-0022-000-0000'),
    line('orphan-peroxide', 'CMPD01-0048-000-0000', 'GR', 'other'),
  ], 6.902553, 0.4172735)
  ...
  assert.equal(result.lines[5].quantity, 1)
})
