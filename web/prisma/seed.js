    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    labelTemplate = _a.sent();
                    console.log("Created Label Template: ".concat(labelTemplate.name));
                    return [4 /*yield*/, prisma.rule.createMany({
                            data: [
                                // Name Component Rules (Order matters by priority)
                                ...
                                { rule_type: 'name_component', target_entity: 'product', condition_expression: 'furniture_name != null', action_type: 'append_text', action_payload: '{furniture_name}', priority: 40 },
                                ...
                                { rule_type: 'name_component', target_entity: 'product', condition_expression: 'rail_type != null', action_type: 'append_text', action_payload: '{rail_type}', priority: 100 },
                                ...
                                { rule_type: 'icon_activation', target_entity: 'product', condition_expression: 'soft_close_hinge_flag == true', action_type: 'activate_icon', action_payload: 'icon-hinge-soft', priority: 1 },
                            ],
                        })];
                case 2:
                    rules = _a.sent();
                    console.log("Created ".concat(rules.count, " rules"));
