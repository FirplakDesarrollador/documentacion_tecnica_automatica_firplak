    ...
    try {
        ...
        BEGIN
            ...
            INSERT INTO public.product_references 
                (family_code, reference_code, product_name, product_type, designation, line, commercial_measure, special_label, width_cm, depth_cm, height_cm, weight_kg, isometric_path, isometric_asset_id, status, ref_attrs)
            VALUES 
