-- Mass Import V6: extend row payload support (version_label, sku_attrs)
-- - Keeps REF_ATTR governance and strict enums behavior unchanged.
-- - Does NOT touch cabinet_products (legacy).
